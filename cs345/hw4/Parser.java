...
public class Parser implements ParserConstants {
  ...
  static final public ASTNode parse() throws ParseException {
 ASTNode root;
    root = let();
                 {if (true) return root;}
...
ASTNode c_node, thisNode;
    ...
    if (jj_2_1(2)) {
      c_node = let();
                        {if (true) return new ASTInnerNode(String.valueOf(a), b, c_node);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LCURLY:
      case ID:
        c_leaf = expr();
                        {if (true) return new ASTLeaf(String.valueOf(a), b, c_leaf);}
        break;
      default:
        jj_la1[0] = jj_gen;
        jj_consume_token(-1);
...
String retVal, exp;
    ...
    case ID:
      s = jj_consume_token(ID);
                  {if (true) return String.valueOf(s.image);}
      break;
    case LCURLY:
      jj_consume_token(LCURLY);
      retVal = expr();
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x240,0x260,0x20,0x240,};
   }
