...
% 4. prolog query 4.
student(STUDENT_ID,_,'Fred',LAST_NAME,_,_,_,_,_), enrollment(STUDENT_ID,SECTION_ID,_,_), section(SECTION_ID,COURSE_NO,_,_,_,INSTRUCTOR_ID,_),course(COURSE_NO,DESCRIPTION,_,_), instructor(INSTRUCTOR_ID,_,FIRST_NAMEi,LAST_NAMEi,_,_,_).
% 5. prolog query 5.
